...
export const TX_FAILED_CHECK_BALANCE =
  'Transaction failed. Check your token balance and try again.';
export const TX_FAILED_PAUSED =
...
export const PAUSE_SUCCESS = (isPaused) =>
  `Marketplace ${isPaused ? 'unpaused' : 'paused'} successfully`;
export const FAILED_TO_TOGGLE_PAUSE = 'Failed to toggle pause state';
export const WALLET_AND_CONTRACT_REQUIRED =
  'Wallet must be connected and contract must be configured';
export const SIGNING_FAILED = 'Signing failed';

export const EMERGENCY_WITHDRAW_CONFIRMED = 'Emergency withdraw confirmed';
export const EMERGENCY_WITHDRAW_TX_FAILED =
  'Emergency withdraw transaction failed';
export const EMERGENCY_WITHDRAW_SUBMITTED =
  'Emergency withdraw submitted, waiting for confirmation…';
...
export const AUTH_FAILED_CHECK_KEY =
...
export const MISSING_REQUIRED_FIELDS = (fields) =>
